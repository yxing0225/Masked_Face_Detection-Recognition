...
class Facenet():
    def __init__(self,para_dict):
        train_img_dir = para_dict['train_img_dir']#CASIA data
        test_img_dir = para_dict['test_img_dir']#LFW data
    ...
    def model_init(self,para_dcit):
        # [Number of pictures,Height,Width,Channels]
        ...
        #inference selection
        if infer_method == "inception_resnet_v1":
        ...
        #loss method---->cross_entropy------->trileptal loss
        ...
        #create the dir to save model weights as pb file
    ...
    def train(self,para_dict):
        ...
        with tf.Session(config=config) as sess:
            ...
            #if there is exciting pb fiels about the weight use it
...
if __name__ == "__main__":
    train_img_dir = r"E:\PycharmProjects\faceNet_and_Data\CASIA-WebFace\CASIA-WebFace"
    test_img_dir = r"E:\PycharmProjects\faceNet_and_Data\lfw\lfw"
    # test_img_dir = None
    label_dict = None
    embed_length = 128
    ...
    opti_method = "adam"
    learning_rate = 5e-4
    save_dir = r"E:\PycharmProjects\8-25\model_saver\test"
    ...
    epochs = 100
    GPU_ratio = None #no limit
    batch_size = 32 #96 not
    ratio = 0.002
