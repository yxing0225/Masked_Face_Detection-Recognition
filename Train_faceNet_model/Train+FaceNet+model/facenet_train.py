    ...
    def train(self,para_dict):
        ...
        with tf.Session(config=config) as sess:
            ...
            for epoch in range(epochs):
               ...
               #testing set evaluation using LFW to test
                if self.test_img_dir is not None:
...
if __name__ == "__main__":
    train_img_dir = [r"E:\PycharmProjects\faceNet_and_Data\CASIA-WebFace\CASIA-WebFace_aligned",
                      r"E:\PycharmProjects\faceNet_and_Data\CASIA-WebFace\CASIA-WebFace_aligned(mask)"]
    test_img_dir = r"E:\PycharmProjects\Train_faceNet_model\LFW_aligned\detect_aligned"
    label_dict = None
    embed_length = 128
    ...
    opti_method = "adam"
    learning_rate = 5e-4
    save_dir = r"E:\PycharmProjects\Train_faceNet_model\model_saver\test_1"
