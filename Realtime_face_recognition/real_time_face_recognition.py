...
# def stream(camera_source=0, resolution="480", to_write=False, save_dir=None):
    ...
    # face detection face recognition init
    ...
    while(cap.isOpened()):
        ...
        if ret is True:
            ...
            # cv2.putText(img, (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 3)

            #----image display
            cv2.imshow("Yue's test", img)

            #----image writing
            if writer is not None:
                writer.write(img)

            #press the q to quit, s to save
...
if __name__ == "__main__":
    #调用模型
    pb_path = r"E:\PycharmProjects\Train_faceNet_model\model_saver\pb_modelepoch20.pb"
    ...
    #对比数据库
    ref_dir = r"E:\PycharmProjects\Realtime_face_recognition\test_database_4\test_reduce"
    stream(pb_path, node_dict, ref_dir, camera_source=0, resolution='480', to_write=True, save_dir=None)
